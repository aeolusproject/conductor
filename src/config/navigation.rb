...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |first_level|
    ...
    first_level.item :administer, t('navigation.first_level.administer'), main_app.users_path, :class => 'administer' do |second_level|
      ...
      second_level.item :environments, t('navigation.second_level.environments'), main_app.pool_families_path, :link => { :class => 'environments' }, :highlights_on => /\/pool_families|\/tim|\/pools\/\d\/provider_selection/
