Feature: Manage Frontend Realms
  In order to manage frontend realms
  As an admin
  I want to add/edit/remove frontend realms
  ...
  Scenario: Show frontend realm detials
  ...
  Scenario: Search Frontend Realms
