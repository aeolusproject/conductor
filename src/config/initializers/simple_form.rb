...
SimpleForm.setup do |config|
  ...
  config.default_wrapper = 'converge-ui-forms'
  ...
  config.wrappers 'converge-ui-forms', :tag => 'div', :class => 'control_group', :error_class => 'error' do |b|
    ...
    b.wrapper :tag => 'div', :class => 'input' do |input|
      input.use :input
      input.use :validation_message_sentence, :wrap_with => { :tag => 'span', :class => 'message' }
      input.use :hint, :wrap_with => { :tag => 'span', :class => 'hint' }
      input.use :note, :wrap_with => { :tag => 'span', :class => 'note' }
    end
